<%@ Page Title="Original - Product | NutriLaddu - Indian Energy Balls" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Original.aspx.cs" Inherits="products_Chocolate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" runat="Server">
    <section class="after-head top-block-page with-back white-curve-after section-white-text">
        <div class="overflow-back bg-original"></div>
        <div class="content-offs-stick my-5 container">
            <div class="section-solid with-back">
                ...
                <div class="z-index-4 position-relative text-center">
                    <h1 class="section-title">Original</h1>
                    <div class="mt-3">
                        <div class="page-breadcrumbs"><a class="content-link" href="/Default">Home</a><span class="mx-2">\</span><a class="content-link" href="/Products">Products</a><span class="mx-2">\</span><span>Original</span></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <section class="section p-5 m-0">
                    <div class="entity">
                        <div class="grid col-auto px-0 row">
                            <div class="col-md-6">
                                <div class="position-relative entity-image bg-original">
                                    <img class="w-100" src="/assets/images/products/The_Origional.png" alt="Original">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h2 class="mb-2 entity-title">Original</h2>
                            ...
                            <div class="col-md-12">
                                <div class="mt-3 mb-4 entity-body">
                                    <h5>Description</h5>
                                    <p>Enjoy this centuries-old Indian super food snack made with plant based natural edible gum (Acacia Gum), dates, and nuts. This is the original recipe, exactly as my mom used to make it. It’s sure to remind you of your mom too. Keeping true to the original recipe these energy balls are made with all natural and healthy ingredients and nothing artificial.</p>
                                </div>
                            </div>
                        </div>
