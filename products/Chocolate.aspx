<%@ Page Title="Chocolate - Product | NutriLaddu - Indian Energy Balls" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Chocolate.aspx.cs" Inherits="products_Chocolate" %>
        ...
        <div class="content-offs-stick my-5 container">
            <div class="section-solid with-back">
                ...
                <div class="z-index-4 position-relative text-center">
                    <h1 class="section-title">Chocolate</h1>
                    <div class="mt-3">
                        <div class="page-breadcrumbs"><a class="content-link" href="/Default">Home</a><span class="mx-2">\</span><a class="content-link" href="/Products">Products</a><span class="mx-2">\</span><span>Chocolate</span></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <section class="section p-5 m-0">
                    <div class="entity">
                        <div class="grid col-auto px-0 row">
                            <div class="col-md-6">
                                <div class="position-relative entity-image bg-chocolate">
                                    <img class="w-100" src="/assets/images/products/Chocolate.png" alt="Chocolate">
                                </div>

                            </div>
                            <div class="col-md-6">
                                <h2 class="mb-2 entity-title">Chocolate</h2>
