<%@ Page Title="Flaxseed - Product | NutriLaddu - Indian Energy Balls" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Flaxseed.aspx.cs" Inherits="products_Chocolate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_content" runat="Server">
    <section class="after-head top-block-page with-back white-curve-after section-white-text">
        <div class="overflow-back bg-flaxseed"></div>
        <div class="content-offs-stick my-5 container">
            <div class="section-solid with-back">
                ...
                <div class="z-index-4 position-relative text-center">
                    <h1 class="section-title">Flaxseed</h1>
                    <div class="mt-3">
                        <div class="page-breadcrumbs"><a class="content-link" href="/Default">Home</a><span class="mx-2">\</span><a class="content-link" href="/Products">Products</a><span class="mx-2">\</span><span>Flaxseed</span></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <section class="section p-5 m-0">
                    <div class="entity">
                        <div class="grid col-auto px-0 row">
                            <div class="col-md-6">
                                <div class="position-relative entity-image bg-flaxseed">
                                    <img class="w-100" src="/assets/images/products/Flaxseed.png" alt="Flaxseed">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h2 class="mb-2 entity-title">Flaxseed</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-4 entity-body">
                                    <p>The Flaxseed flavor is mild and perfectly nutty with a deep earthy appeal that increases your natural energy. Our energy balls are packaged in pairs in a resealable pouch so they stay fresh and you can snack conveniently. It’s time to indulge and feel great!</p>
                                </div>
                                ...
                                <ol class="font-weight-semibold mt-2">
                                    ...
                                    <li>Flaxseed which is loaded with nutrients and omega-3 healthy fats. These seeds are also rich in dietary fiber and can improve cholesterol as well as lower blood pressure.</li>
                                </ol>
                            </div>
                        </div>
